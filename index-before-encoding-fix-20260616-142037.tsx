            ...
            <div className="grid gap-10 lg:grid-cols-[0.88fr_1.12fr] lg:items-stretch">
              ...
              <div className="rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 sm:p-8 lg:p-10">
                <div className="space-y-5 text-sm leading-7 text-slate-300 sm:text-base sm:leading-8">
                  ...
                  <p>
                    Recognizing the challenges that have long affected the industryâ€”including fragmented deal flow, limited access to credible opportunities, and the lack of transparency that often undermines investor confidenceâ€”Dahir set out to build a platform that prioritizes accountability, verification, and professional standards.
                  </p>
                ...
                <blockquote className="mt-8 rounded-[1.6rem] border-l-4 border-[#C9A227] bg-[#C9A227]/10 p-5 text-base font-semibold leading-8 text-white sm:text-lg sm:leading-9">
                  â€œWe are building more than a marketplace. We are building the trusted infrastructure that connects capital, opportunity, and people to unlock the next generation of real estate growth across Africa.â€
                </blockquote>
              </div>
            </div>
          </div>
        ...
        <section className="bg-white px-4 py-16 sm:px-6 sm:py-20 lg:px-10">
          <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
            ...
            <div className="space-y-5 text-base leading-8 text-slate-600 sm:text-lg sm:leading-9">
              <p>
                At INAMAAD, we believe that sustainable growth in real estate requires more than access to opportunitiesâ€”it requires confidence in the people, information, and processes behind them.
              </p>
